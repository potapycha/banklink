...
public class Danske extends Banklink {
    ...
    public Danske(Protocol protocol) {
        ...
        super.testRequestUri = this.getConfigurationParameters().getBaseTestUrl() + "/sampo";
    ...
    public Danske(Protocol protocol, ConfigurationParameters configurationParameters) {
        super(protocol, configurationParameters);
        super.requestUri = "https://e.danskebank.ee/ib/site/ibpay/login";
        super.testRequestUri = configurationParameters.getBaseTestUrl() + "/sampo";
        super.fields = new Fields();
    }
